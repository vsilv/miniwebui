            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProjects.map((project) => (
                ...
                >
                  ...
                  <div
                    className={`h-24 bg-gradient-to-r ${getProjectColor(
                      project.title
                ...
                <table className="min-w-full divide-y divide-dark-200 dark:divide-dark-700">
                  <thead className="bg-light-100 dark:bg-dark-900/50">
                    <tr>
                      <th
                        scope="col"
                        className="px-6 py-3 text-left text-xs font-medium text-dark-500 dark:text-dark-400 uppercase tracking-wider"
                      >
                        Projet
                      </th>
                      <th
                      ...
                      <th
                        scope="col"
                        className="px-6 py-3 text-right text-xs font-medium text-dark-500 dark:text-dark-400 uppercase tracking-wider"
                      >
                        Actions
                      </th>
                    </tr>
                  ...
                  <tbody className="bg-white dark:bg-dark-800 divide-y divide-dark-200 dark:divide-dark-700">
                    {filteredProjects.map((project) => (
                      <tr
                        key={project.id}
                        className="hover:bg-light-100 dark:hover:bg-dark-700/50 transition-colors"
                      >
                        <td className="px-6 py-4">
                          ...
                          >
                            <div
                              className={`h-10 w-10 rounded-lg bg-gradient-to-r ${getProjectColor(
                                project.title
                        ...
                        <td className="px-6 py-4">
                          <div className="text-dark-600 dark:text-dark-400 truncate max-w-xs">
                            {project.description || (
                              <span className="text-dark-500 dark:text-dark-500 italic">
                                Aucune description
                              </span>
                            )}
                          </div>
